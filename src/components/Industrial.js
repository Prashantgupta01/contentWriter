    ...
    <div className='m-auto px-5 md:px-24 lg:px-36 my-10'>
        <div className='md:flex'>
              <div className='basis-6/12 '>
                  ...
                  <p className='mt-5  '><span className='text-[15px] text-[500] text-white bg-black px-4 py-1'>
                  Tell Us Your Requirements
                    </span></p>
              </div>
              <div className='basis-6/12'>
                  <div className='flex justify-center gap-5 '>
                      <div className='flex flex-col items-center mt-16 border rounded-md px-5'>
        ...
        <div>
            <Image className='w-full h-full bg-cover' width={1300} height={869} alt='' src={"/assets/images/image f.png"} />
        </div>
    </div>
  )
}
